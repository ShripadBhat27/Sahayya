...
//    private AppDatabase appDatabase;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        String amount, transaction_id;
        amount="+"+transactionEntries.get(position).getAmount();
        transaction_id = "transaction id :" +  transactionEntries.get(position).gettransaction_id();
        holder.categoryTextViewrv.setText(transactionEntries.get(position).getNgo());
...
//        String dateToBeSet=sdf.format(transactionEntries.get(position).getNgowebsite());
//        holder.dateTextViewrv.setText(dateToBeSet);
//        holder.descriptionTextViewrv.setText(transactionEntries.get(position).getNgodescription());
    }
