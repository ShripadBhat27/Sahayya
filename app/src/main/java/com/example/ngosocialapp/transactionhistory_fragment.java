 ...
 * Use the {@link transactionhistory_fragment#newInstance} factory method to
...
//    private AppDatabase mAppDb;
     ...
     * @return A new instance of fragment transactionhistory_fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static transactionhistory_fragment newInstance(String param1, String param2) {
        transactionhistory_fragment fragment = new transactionhistory_fragment();
        ...
        userref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot it : snapshot.getChildren())
                {
                    ...
                    String ngo = t.getNGO();
                    TransactionEntry new_transaction_entry = new TransactionEntry(ammount,ngo,id);
